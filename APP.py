...
# 加载 JSON 格式模型
model = xgb.Booster()
model.load_model("D:/Machine learning/xgboost_model.json")
...
with col1:
    ...
    if st.button("Predict"):
        ...
        with col2:
            ...
            # 绘制局部 SHAP 力图
            st.header(f"Based on feature values, predicted probability of Return to Work is {predicted_probability * 100:.2f}%")
            shap.force_plot(
